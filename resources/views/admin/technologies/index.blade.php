...
<div class="container">
    ...
    @endif
    <a name="add" id="add" class="text-uppercase btn btn-danger mb-3" href="{{ route('admin.technologies.create') }}" role="button">add new tech</a>
        ...
        <table class="table table-secondary m-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center align-middle" width="25%" scope="row">
                        <span class="text-lowercase">{{$technology->color}}</span>
                    </td>
